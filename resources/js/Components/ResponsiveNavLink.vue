...
const classes = computed(() => {
    return props.active
        ? 'block pl-3 pr-4 py-2 border-l-4 border-indigo-400 text-base font-medium text-primary bg-indigo-50 focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-primary transition'
