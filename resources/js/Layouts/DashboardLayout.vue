...
<template>
    ...
    <div class="flex w-full h-screen">
        ...
        >
            ...
            <main id="page" class="flex h-full justify-center md:p-2 overflow-y-auto">
                <div  class="w-full shadow-lg h-full md:h-[calc(100vh-4.5rem)] px-2 md:px-8 pb-4 sm:px-6 lg:px-8 md:rounded-lg bg-white lg:py-4">
